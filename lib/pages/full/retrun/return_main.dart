...
import 'package:flutter_mixcall_normaluser_new/pages/full/retrun/widget/return_updown.dart';
import 'package:flutter_mixcall_normaluser_new/setting/helper_widget/helper.dart';
import 'package:flutter_mixcall_normaluser_new/setting/theme/my_theme.dart';
import 'package:flutter_mixcall_normaluser_new/setting/widget/text_widget.dart';

class FullReturnMainPage extends StatelessWidget {
  final Map<String, dynamic> cargo;
  const FullReturnMainPage({super.key, required this.cargo});
        ...
        SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                //  / Text(cargo['id']),
                FullReturnUpDown(cargoData: cargo),
