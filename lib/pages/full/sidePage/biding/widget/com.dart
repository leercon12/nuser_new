...
class BidingComWidget extends StatefulWidget {
  final Map<String, dynamic> data;
  final Map<String, dynamic> cargo;
  const BidingComWidget({super.key, required this.cargo, required this.data});

  @override
  State<BidingComWidget> createState() => _BidingComWidgetState();
}

class _BidingComWidgetState extends State<BidingComWidget> {
  @override
  Widget build(BuildContext context) {
    final mapProvider = Provider.of<MapProvider>(context);
    final dataProvider = Provider.of<DataProvider>(context);
    final bool isConfirmed =
        widget.cargo['confirmUser'] == widget.data['comUid'];
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(100),
                                child:
                                    buildProfileImage(widget.data['photoUrl']),
                              ),
                            ),
                          ],
                        ),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          KTextWidget(
                                              ...
                                              color: kRedColor)
                                          /* CountdownTimer(
                                            timestamp: widget.cargo['comDate'],
                                            size: 14,
                                            color: kRedColor,
                                          ) */
                                        ],
